      ...
      <div className="py-4 border-b border-gray-300">
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="">
            ...
            <FilterItem data={filterPriceLaptop.filters} />
          </div>
          {/* Type */}
          <div className="">
            <h3 className="font-bold ">Loại điện thoại</h3>
            <FilterItem data={filterTypeLaptop.filters} />
          </div>
          <div className="">
            <h3 className="font-bold ">Ram</h3>
            <FilterItem data={filterRamLaptop.filters} />
          </div>
        </div>
      </div>
      <div className="py-4 border-b border-gray-300">
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="">
            ...
            <FilterItem data={filterStorageLaptop.filters} />
          </div>
        </div>
      </div>
