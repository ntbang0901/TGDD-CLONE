    ...
    <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 z-20 py-2 gap-2 sticky top-0 bg-white shadow-md px-2 rounded-md">
      <div className="m-auto">
        {loadingFilter ? (
          ...
          <Badge badgeContent={filters ? filters.length : 0} color="secondary">
            <ButtonPopover
              icon={
                <svg
        ...
        <ButtonPopover
          ...
          Component={
            <FilterButton
              category={category}
              filters={filters}
              data={filterPriceTablet.filters}
            />
          }
        />
      </div>
        ...
        <ButtonPopover
          ...
          Component={
            <FilterButton
              category={category}
              filters={filters}
              data={filterPerformanceTablet.filters}
            />
          }
        />
      </div>
        ...
        <ButtonPopover
          ...
          Component={
            <FilterButton
              category={category}
              filters={filters}
              data={filterStorageTablet.filters}
            />
          }
        />
      </div>
