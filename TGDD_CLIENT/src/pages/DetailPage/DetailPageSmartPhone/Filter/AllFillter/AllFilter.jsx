      ...
      <div className="py-4 border-b border-gray-300">
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="">
            ...
            <FilterItem data={filterPriceSmartphone.filters} />
          </div>
          {/* Type */}
          <div className="">
            <h3 className="font-bold ">Loại điện thoại</h3>
            <FilterItem data={filterTypeSmartphone.filters} />
          </div>
          {/* Performance */}
          <div className="">
            <h3 className="font-bold ">Hiệu năng & pin</h3>
            <FilterItem data={filterPerformanceSmartphone.filters} />
          </div>
        </div>
      </div>
      <div className="py-4 border-b border-gray-300">
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="">
            ...
            <FilterItem data={filterRamSmartphone.filters} />
          </div>
          {/* Storage */}
          <div className="">
            <h3 className="font-bold ">Bộ nhớ trong</h3>
            <FilterItem data={filterStorageSmartphone.filters} />
          </div>
          {/* Performance */}
          <div className="">
            <h3 className="font-bold ">Camera</h3>
            <FilterItem data={filterCameraSmartphone.filters} />
          </div>
        </div>
      </div>
