...
import { ADD_NEW_TABLET_PAGE_SAGA } from "../../../../../redux/sagas/types/main";
import AddSlider from "../../../global/ManagerAction/AddSlider";

function AddNewTabletPage(props) {
      ...
      >
        <div className="px-4">
          <h1 className="text-center font-normal text-2xl">
            Tạo quảng cáo cho trang tablet
          </h1>
          <div className="">
            <AddSlider
...
export default AddNewTabletPage;
