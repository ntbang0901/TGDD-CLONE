...
import { EDIT_PC_PAGE_SAGA } from "../../../../../redux/sagas/types/main";
import AddSlider from "../../../global/ManagerAction/AddSlider";

function EditPCPage(props) {
  ...
  const { handleSubmit, values, errors, touched, setFieldValue } = useFormik({
    ...
    initialValues: {
      _id: dataPCPage[finalIndex]?._id,
      sliders: dataPCPage[finalIndex]?.sliders,
    },
