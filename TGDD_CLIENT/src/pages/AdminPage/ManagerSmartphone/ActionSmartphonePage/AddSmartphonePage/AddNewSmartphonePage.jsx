...
import { ADD_NEW_SMARTPHONE_PAGE_SAGA } from "../../../../../redux/sagas/types/main";
import AddSlider from "../../../global/ManagerAction/AddSlider";

function AddNewSmartphonePage(props) {
  ...
  const { handleSubmit, values, errors, touched, setFieldValue } = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch({
        type: ADD_NEW_SMARTPHONE_PAGE_SAGA,
      ...
      >
        <div className="px-4">
          <h1 className="text-center font-normal text-2xl">
            Tạo quảng cáo trang điện thoại
          </h1>
          <div className="">
            <AddSlider
...
export default AddNewSmartphonePage;
