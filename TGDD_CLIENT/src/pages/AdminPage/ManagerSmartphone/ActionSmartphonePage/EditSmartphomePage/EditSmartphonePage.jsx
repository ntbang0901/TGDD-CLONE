...
import { EDIT_SMARTPHONE_PAGE_SAGA } from "../../../../../redux/sagas/types/main";
import AddSlider from "../../../global/ManagerAction/AddSlider";

function EditSmartphonePage(props) {
  ...
  const { handleSubmit, values, errors, touched, setFieldValue } = useFormik({
    ...
    initialValues: {
      _id: dataSmartphonePage[finalIndex]?._id,
      sliders: dataSmartphonePage[finalIndex]?.sliders,
    },
    ...
    onSubmit: (values) => {
      ...
      dispatch({
        type: EDIT_SMARTPHONE_PAGE_SAGA,
...
export default EditSmartphonePage;
